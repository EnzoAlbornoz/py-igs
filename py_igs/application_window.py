...
class ApplicationWindow(Gtk.ApplicationWindow):
    ...
    dialog_object_edit_rotate_axis_x: Any = Gtk.Template.Child("window-object-edit-rotate-around-axis-x")
    dialog_object_edit_rotate_axis_y: Any = Gtk.Template.Child("window-object-edit-rotate-around-axis-y")
    dialog_object_edit_rotate_axis_z: Any = Gtk.Template.Child("window-object-edit-rotate-around-axis-z")
