...
class Context:
    ...
    def get_dash(self) -> Tuple[tuple, float]: ...
    ...
    def mask_surface(self, surface: Any, x: float = 0.0, y: float = 0.0) -> None: ...
    ...
    def set_dash(self, dashes: List[Any], offset: float = 0.0) -> None: ...
    ...
    def set_source_rgba(self, red: float, green: float, blue: float, alpha: Optional[float] = 1.0) -> None: ...
    def set_source_surface(self, surface, x: Optional[float] = 0.0, y: Optional[float] = 0.0) -> None: ...
    ...
    def show_text_glyphs(self, utf8: str, glyphs: list, clusters: list, cluster_flags: Any) -> None: ...
    def stroke_to_path(self) -> None: ...
    def tag_begin(self, tag_name: str, attributes: str) -> None: ...
    def tag_end(self, tag_name: str) -> None: ...

class Matrix:
    def __init__(self, xx: float = 1.0, yx: float = 0.0, xy: float = 0.0, yy: float = 1.0, x0: float = 0.0, y0: float = 0.0) -> Matrix: ...
    @classmethod
    def init_rotate(radians: float) -> Matrix: ...
    def invert(self) -> None: ...
    def multiply(self, matrix2: Matrix) -> Matrix: ...
    def rotate(radians: float) -> None: ...
    def scale(sx: float, sy: float) -> None: ...
    def transform_distance(dx: float, dy: float) -> Tuple[float, float]: ...
